...
export function HomePage() {
  ...
  return (
    <div className="relative flex min-h-full flex-col items-center justify-center px-4 pt-12 pb-14 text-center sm:px-6 sm:pt-16 sm:pb-16 lg:pt-24 lg:pb-20">
      <div className="my-auto flex w-full flex-col items-center">
        ...
        <div className="page-enter relative mt-12 grid w-full max-w-6xl gap-4 text-left sm:grid-cols-2 lg:grid-cols-4" style={{ animationDelay: '180ms' }}>
        <div className="mc-btn group flex flex-col justify-between gap-4 rounded-none p-5 transition-colors duration-150 hover:border-[var(--accent)]/50">
          <div className="flex flex-col gap-2.5">
            <div className="flex items-center justify-between">
              <span className="mc-icon-btn h-10 w-10 rounded-none text-[var(--accent)]">
                <FileCode2 size={19} />
              </span>
              <span className="font-mono text-[10px] text-[#6c7086] uppercase">{serverTools.length} Tools</span>
            </div>
            <h2 className="font-mc text-[17px] text-[#cdd6f4]">Server & Config</h2>
        ...
        <div className="mc-btn group flex flex-col justify-between gap-4 rounded-none p-5 transition-colors duration-150 hover:border-[var(--accent)]/50">
          <div className="flex flex-col gap-2.5">
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-[10px] text-[#6c7086] uppercase">{textTools.length} Tools</span>
            </div>
            <h2 className="font-mc text-[17px] text-[#cdd6f4]">Text & Formatting</h2>
            <p className="text-[12px] leading-relaxed text-[#a6adc8]">
        ...
        <div className="mc-btn group flex flex-col justify-between gap-4 rounded-none p-5 transition-colors duration-150 hover:border-[var(--accent)]/50">
          <div className="flex flex-col gap-2.5">
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-[10px] text-[#6c7086] uppercase">{worldTools.length} Tools</span>
            </div>
            <h2 className="font-mc text-[17px] text-[#cdd6f4]">World & Building</h2>
            <p className="text-[12px] leading-relaxed text-[#a6adc8]">
        ...
        <div className="mc-btn group flex flex-col justify-between gap-4 rounded-none p-5 transition-colors duration-150 hover:border-[var(--accent)]/50">
          <div className="flex flex-col gap-2.5">
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-[10px] text-[#6c7086] uppercase">{playerTools.length} Tools</span>
            </div>
            <h2 className="font-mc text-[17px] text-[#cdd6f4]">Player & Cosmetics</h2>
            <p className="text-[12px] leading-relaxed text-[#a6adc8]">
      ...
      <div className="page-enter relative mt-10 flex items-center gap-2 font-mono text-[11px] text-[#6c7086]" style={{ animationDelay: '240ms' }}>
